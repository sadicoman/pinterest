    ...
    <div className="min-h-screen flex items-center justify-center bg-pinterest-light-gray">
      <div className="bg-white p-8 rounded-3xl shadow-lg w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Rejoignez Pinterest</h1>
          <p className="text-gray-600">Trouvez de nouvelles idées à essayer</p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            Déjà un compte ?{' '}
            <Link href="/login" className="text-pinterest-primary font-semibold hover:underline">
              Se connecter
            </Link>
          </p>
        </div>
